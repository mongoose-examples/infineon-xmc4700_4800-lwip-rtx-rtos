...
CFLAGS = -MMD -MT -O0 -DXMC4700_F144x2048 -DMG_ARCH=8 -DMAKE_BUILD -ffunction-sections -fdata-sections -fno-common -std=gnu99 -Wno-attributes -mfloat-abi=softfp -pipe -c -fmessage-length=0 -MMD -MP -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mthumb -g -gdwarf-2
